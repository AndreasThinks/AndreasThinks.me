...
- **[Statistics 101 for Evaluation](statistics_101_for_evaluation/index.qmd)** | [Session Summary (Nov 2, 2025)](statistics_101_for_evaluation/summary.qmd)
  Foundational statistics for rigorous evaluation: understanding distributions, sample sizes and variance; using p-values and confidence intervals in experiments; planning with power calculations; interpreting regressions; and understanding Bayesian approaches to inference.
