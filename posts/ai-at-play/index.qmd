...
mastodon_comments:
  user: "AndreasThinks"
  host: "fosstodon.org"
  toot_id: "114958602908444442"
bluesky_comments:
  post_uri: "https://bsky.app/profile/andreasthinks.me/post/3lvfvzoej322p"
---
::: {#description-meta}
...
Now, I don't work at Anthropic (and I definitely don't have as many credits as they do), but I do love games, and think they tell us something about the people playing them. So, inspired by Claude Plays Pokemon, I've built my own little experiment in LLM gaming: **[AIs at Risk](https://ai-at-play.online/)**, a cute, silly little benchmark that I think _might_ just tell us something meaningful.
:::
...
**This was a lightning talk at [WHY2025](https://why2025.org/)!** The slides are available below

{{< revealjs "assets/presentation.html" >}}
...
It turns out that is a _huge_ amount of context, and it's really hard to convey *all that stuff*.
