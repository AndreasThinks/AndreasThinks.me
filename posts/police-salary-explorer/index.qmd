...
viewof showBenchmarks = Inputs.toggle({label: "Show benchmark lines", value: false})
...
medianLine = raw.map(d => ({
  Year: +d.Year,
  Salary: realTerms ? +d.Median_FT_Annual_Real2025 : +d.Median_FT_Annual_Nominal
}))
...
chart = Plot.plot({
  ...
  marks: [
    Plot.ruleY([0]),
    showBenchmarks && indexBy === "Absolute salary" ? Plot.lineY(minWageLine, {
      x: "Year",
      y: "Salary",
      stroke: "#ff6b6b",
      strokeWidth: 1.5,
    ...
    showBenchmarks && indexBy === "Absolute salary" ? Plot.lineY(medianLine, {
      x: "Year",
      y: "Salary",
      stroke: "#00d4ff",
      strokeWidth: 1.5,
